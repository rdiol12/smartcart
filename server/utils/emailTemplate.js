            ...
            <tr>
              <td dir="rtl" style="padding:36px 32px 24px 32px;direction:rtl;text-align:right;">
                ...
                <table dir="rtl" role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="direction:rtl;">
                  <tr>
                    <td align="center" dir="rtl" style="direction:rtl;text-align:center;">
                      <a href="${escapeHtml(ctaUrl)}" style="display:inline-block;background-color:#4f46e5;background-image:linear-gradient(135deg,#4f46e5 0%,#6366f1 100%);color:#ffffff;text-decoration:none;padding:14px 36px;border-radius:12px;font-weight:600;font-size:15px;box-shadow:0 4px 12px rgba(79,70,229,0.25);">${escapeHtml(ctaText)}</a>
                    </td>
                  </tr>
                </table>
                <p dir="rtl" style="margin:32px 0 0 0;font-size:13px;line-height:1.65;color:#64748b;direction:rtl;text-align:right;">
                  ...
                  <a href="${escapeHtml(ctaUrl)}" dir="ltr" style="color:#4f46e5;word-break:break-all;direction:ltr;unicode-bidi:embed;">${escapeHtml(ctaUrl)}</a>
                </p>
              </td>
            </tr>
            <tr>
